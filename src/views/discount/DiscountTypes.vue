...
export default {
    ...
    methods: {
        ...mapActions('DiscountTypesStore', ['getDiscountTypes', 'setDiscountType', 'actionDiscountType', 'deleteDiscountType']),
        /*
         * Form Create
         * */
        formCreate(item = {}) {
         ...
         * */
        remove(id) {
            this.alert().then(r => this.deleteDiscountType(id).then(r => this.getDiscountTypes()))
        },
        /*
         * Action
         * */
        action(item, type) {
            ...
            this.actionDiscountType({id: item.id, type, action}).then(r => this.getDiscountTypes())
        },
        /*
         * Save
         * */
