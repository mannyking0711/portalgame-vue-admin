                ...
                <form @submit.prevent="save">
                    <grid>
                        ...
                        <form-group
                            ...
                            name="level"
                        >
                            <form-number v-model="form.level"/>
                        </form-group>
...
const translateKey = 'crm.GameLevel';
...
export default {
    ...
    data() {
        return {
            ...
            columns: [
                ...
                {
                    caption: translateKey + '.Label.Level',
                    dataField: 'level',
                    show: true,
    ...
    methods: {
        ...mapActions('GameLevelStore', ['getGameLevels', 'setGameLevel', 'actionGameLevel', 'deleteGameLevel']),
        /*
         * Form Create
         * */
        formCreate(item = {}) {
         ...
         * */
        remove(id) {
            this.alert().then(r => this.deleteGameLevel(id).then(r => this.getGameLevels()))
        },
        /*
         * Action
         * */
        action(item, type) {
            ...
            this.actionGameLevel({id: item.id, type, action}).then(r => this.getGameLevels())
        },
        /*
         * Save
         * */
        save() {
            this.setGameLevel(this.form)
            .then(r => {
                if (r) {
                    this.modal(this.modalId);
                    this.getGameLevels();
