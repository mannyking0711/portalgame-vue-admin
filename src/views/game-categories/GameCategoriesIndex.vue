...
const translateKey = 'crm.GameCategories';

export default {
    name: "GameCategoriesIndex",
    data() {
        return {
            translateKey,
            modalId,
    ...
    methods: {
        ...mapActions('GameCategoriesStore', ['getGameCategories', 'setGameCategorie', 'actionGameCategorie', 'deleteGameCategorie']),
        /*
         * Form Create
         * */
        formCreate(item = {}) {
         ...
         * */
        remove(id) {
            this.alert().then(r => this.deleteGameCategorie(id).then(r => this.getGameCategorie()))
        },
        /*
         * Action
         * */
        action(item, type) {
            ...
            this.actionGameCategorie({id: item.id, type, action}).then(r => this.getGameCategories())
        },
        /*
         * Save
         * */
        save() {
            this.setGameCategorie(this.form)
            .then(r => {
                if (r) {
                    this.modal(this.modalId);
