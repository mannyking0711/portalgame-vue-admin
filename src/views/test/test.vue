                ...
                <form @submit.prevent="save">
                    <grid>
                        ...
                        <form-group
                            ...
                            name="photos"
                        >
                            <form-photos :col="3" path="vacancies" :item-photos="photoItems" img-height="110px" v-model="form.photos"/>
                        </form-group>
...
export default {
    ...
    computed: {
        ...mapState('TestStore', ['vacancies']),
        permission() {
            return this.currentPage.permission;
        }
    },
    methods: {
        ...mapActions('TestStore', ['getVacancies', 'setVacancie', 'actionVacancie', 'deleteVacancie']),
        /*
         * Form Create
         * */
        formCreate(item = {}) {
