...
const translateKey = 'crm.GameStatus';
...
export default {
    ...
    methods: {
        ...mapActions('GameStatusStore', ['getGameStatuses', 'setGameStatus', 'actionGameStatus', 'deleteGameStatus']),
        /*
         * Form Create
         * */
        formCreate(item = {}) {
         ...
         * */
        remove(id) {
            this.alert().then(r => this.deleteGameStatus(id).then(r => this.getGameStatuses()))
        },
        /*
         * Action
         * */
        action(item, type) {
            ...
            this.actionGameStatus({id: item.id, type, action}).then(r => this.getGameStatuses())
        },
        /*
         * Save
         * */
        save() {
            this.setGameStatus(this.form)
            .then(r => {
                if (r) {
                    this.modal(this.modalId);
                    this.getGameStatuses();
                }
            })
        }
    },
