...
const translateKey = 'crm.GameLanguage';

export default {
    name: "GameLanguageIndex",
    data() {
        return {
            translateKey,
            modalId,
    ...
    methods: {
        ...mapActions('GameLanguageStore', ['getGameLanguages', 'setGameLanguage', 'actionGameLanguage', 'deleteGameLanguage']),
        /*
         * Form Create
         * */
        formCreate(item = {}) {
         ...
         * */
        remove(id) {
            this.alert().then(r => this.deleteGameLanguage(id).then(r => this.getGameLanguages()))
        },
        /*
         * Action
         * */
        action(item, type) {
            ...
            this.actionGameLanguage({id: item.id, type, action}).then(r => this.getGameLanguages())
        },
        /*
         * Save
         * */
        save() {
            this.setGameLanguage(this.form)
            .then(r => {
                if (r) {
                    this.modal(this.modalId);
                    this.getGameLanguages();
                }
            })
        }
    },
