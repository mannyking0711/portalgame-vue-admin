...
const translateKey = 'crm.PaymentType';
...
export default {
    ...
    computed: {
        ...mapState('PaymentTypeStore', ['paymentTypes']),
        permission() {
            return this.currentPage.permission;
        }
    },
    methods: {
        ...mapActions('PaymentTypeStore', ['getPaymentTypes', 'setPaymentType', 'actionPaymentType', 'deletePaymentType']),
        /*
         * Form Create
         * */
        formCreate(item = {}) {
         ...
         * */
        remove(id) {
            this.alert().then(r => this.deletePaymentType(id).then(r => this.getPaymentTypes()))
        },
        /*
         * Action
         * */
        action(item, type) {
            ...
            this.actionPaymentType({id: item.id, type, action}).then(r => this.getPaymentTypes())
        },
        /*
         * Save
         * */
        save() {
            this.setPaymentType(this.form)
            .then(r => {
                if (r) {
                    this.modal(this.modalId);
